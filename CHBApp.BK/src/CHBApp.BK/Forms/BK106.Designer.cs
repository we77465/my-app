...
partial class BK106
{
    ...
    private System.Windows.Forms.Label lblTitle, lblKeyLbl, lblEmpNoLbl, lblEmpNoVal, lblAcc, lblPayLbl,
    ...
    private void InitializeComponent()
    {
        ...
        lblTitle = new System.Windows.Forms.Label { Text = "薪資輸入－姓名", Location = new System.Drawing.Point(180, 75), Size = new System.Drawing.Size(170, 24), Font = new System.Drawing.Font("標楷體", 13F, System.Drawing.FontStyle.Bold), TextAlign = System.Drawing.ContentAlignment.MiddleCenter };
        lblKeyLbl = new System.Windows.Forms.Label { Text = "員工姓名", Location = new System.Drawing.Point(120, 115), Size = new System.Drawing.Size(80, 21) };
        txtKey = new System.Windows.Forms.TextBox { Location = new System.Drawing.Point(210, 112), Size = new System.Drawing.Size(150, 23), MaxLength = 10, PlaceholderText = "輸入姓名 (Enter 帶出)" };
        ...
        Controls.AddRange(new System.Windows.Forms.Control[] { toolBar, lblTitle, lblKeyLbl, txtKey, lblEmpNoLbl, lblEmpNoVal, lblAcc, txtAccNo, lblPayLbl, numPay, lblFlag, cbFlag, lblKind, cbKind, lblCustomKind, txtCustomKind, lblNote, lblCheck, rbCheckYes, rbCheckNo, lblSep, lblMail, txtMail, lblContent, txtContent, statusBar });
        Name = "BK106"; StartPosition = System.Windows.Forms.FormStartPosition.CenterParent; Text = "薪資輸入－姓名";
    }
}
