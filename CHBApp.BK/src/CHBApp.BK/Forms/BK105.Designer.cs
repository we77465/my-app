...
partial class BK105
{
    ...
    private System.Windows.Forms.Label lblTitle, lblKeyLbl, lblNameLbl, lblName, lblAcc, lblPayLbl,
                                       lblFlag, lblKind, lblNote, lblCheck, lblSep, lblMail, lblContent, lblCustomKind;
    private System.Windows.Forms.TextBox txtKey, txtAccNo, txtMail, txtContent, txtCustomKind;
    ...
    private void InitializeComponent()
    {
        ...
        btnSave = TBtn("儲存"); btnCancel = TBtn("取消");
        btnFirst = TBtn("首筆"); btnPrev = TBtn("上筆"); btnNext = TBtn("下筆"); btnLast = TBtn("末筆");
        ...
        lblTitle = new System.Windows.Forms.Label { Text = "薪資輸入－代號", Location = new System.Drawing.Point(180, 75),
            Size = new System.Drawing.Size(170, 24), Font = new System.Drawing.Font("標楷體", 13F, System.Drawing.FontStyle.Bold),
            TextAlign = System.Drawing.ContentAlignment.MiddleCenter };

        lblKeyLbl = new System.Windows.Forms.Label { Text = "員工編號", Location = new System.Drawing.Point(120, 115), Size = new System.Drawing.Size(80, 21) };
        txtKey = new System.Windows.Forms.TextBox { Location = new System.Drawing.Point(210, 112), Size = new System.Drawing.Size(150, 23),
                                                     MaxLength = 10, PlaceholderText = "輸入員工編號 (Enter 帶出)" };
        txtKey.KeyDown += txtKey_KeyDown;

        lblNameLbl = new System.Windows.Forms.Label { Text = "姓     名", Location = new System.Drawing.Point(120, 145), Size = new System.Drawing.Size(80, 21) };
        lblName = new System.Windows.Forms.Label { Text = "", Location = new System.Drawing.Point(210, 145), Size = new System.Drawing.Size(180, 21),
            Font = new System.Drawing.Font("新細明體", 10F, System.Drawing.FontStyle.Bold) };

        lblAcc = new System.Windows.Forms.Label { Text = "帳     號", Location = new System.Drawing.Point(120, 175), Size = new System.Drawing.Size(80, 21) };
        txtAccNo = new System.Windows.Forms.TextBox { Location = new System.Drawing.Point(210, 172), Size = new System.Drawing.Size(180, 23), ReadOnly = true };
        ...
        lblSep = new System.Windows.Forms.Label { Text = "---------------以下為非必要欄位---------------",
        ...
        Controls.AddRange(new System.Windows.Forms.Control[] {
            toolBar, lblTitle, lblKeyLbl, txtKey, lblNameLbl, lblName, lblAcc, txtAccNo,
            lblPayLbl, numPay, lblFlag, cbFlag, lblKind, cbKind,
